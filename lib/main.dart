...
Этот код — это полностью готовый файл `main.dart`. Если ты установишь Flutter или воспользуешься онлайн-редактором (например, DartPad или Zapp), ты сможешь вставить туда этот код, и он запустится как полноценное приложение на экране смартфона!

Введя число, например 10, программа, как ты и задумывал, успокоит пользователя, сообщив: *"Завтра твой лимит составит 15 сигарет"*.
